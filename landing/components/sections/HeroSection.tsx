...
// Load the 3D core lazily, no SSR. Copy must be visible immediately.
const EconomicCore3D = dynamic(() => import("../three/EconomicCore3D"), {
  ssr: false,
  loading: () => <div className="w-full h-full bg-[#050505]" />,
});

// Official platform URL — every non-mailto button on the landing goes here.
    ...
    <section className="relative w-full h-screen flex items-center justify-center overflow-hidden bg-[#050505]">
      ...
      <div className="relative z-20 text-center px-6 max-w-4xl">
        ...
        >
          ...
          <br />
          <span className="text-glow-cyan">{t.hero.headlineLine2}</span>
        </motion.h1>
