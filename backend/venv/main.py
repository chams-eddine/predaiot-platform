...
# ==========================================
# 4. محرك التحسين النهائي (مع قيد نهاية اليوم المضاف)
# ==========================================
...
# ==========================================
# 6. دمج الواجهة الأمامية (Production Mode)
# ==========================================
# تحديد مسار مجلد الواجهة المبنية
frontend_path = os.path.abspath("../frontend/dist")

# إذا وجد المجلد، قم بتقديم الملفات للعميل
